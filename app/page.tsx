    ...
    <div className="min-h-screen apple-hero">
      ...
      <section className="relative py-32 px-6">
        <div className="container mx-auto text-center max-w-5xl">
          <div className="apple-animate-in">
            ...
            <h1 className="text-7xl md:text-8xl font-black text-slate-800 leading-tight mb-8">
              Meet Your
              <br />
              <span className="apple-text-gradient">Future Self</span>
            </h1>
            
            <p className="text-2xl calm-text mb-12 max-w-3xl mx-auto leading-relaxed font-light">
      ...
      <section id="features" className="py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl calm-text max-w-2xl mx-auto font-light">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="apple-card rounded-3xl p-8 text-center group">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Build Your Memory</h3>
            ...
            <div className="apple-card rounded-3xl p-8 text-center group">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Meaningful Conversations</h3>
              <p className="calm-text leading-relaxed">
            ...
            <div className="apple-card rounded-3xl p-8 text-center group">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Guided Growth</h3>
              <p className="calm-text leading-relaxed">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">Share Your Story</h3>
              <p className="calm-text leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">AI Processing</h3>
              <p className="calm-text leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">Ask Questions</h3>
              <p className="calm-text leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">Get Guidance</h3>
              <p className="calm-text leading-relaxed">
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="apple-card rounded-3xl p-12 text-center">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-6">
              Your conversations are <span className="text-emerald-600">private and secure</span>
            </h2>
            <p className="text-xl calm-text mb-8 max-w-2xl mx-auto leading-relaxed">
              We use enterprise-grade security to protect your personal information. 
              Your data stays private, and your conversations remain between you and your future self.
            </p>
            <div className="flex justify-center space-x-8 text-sm">
              <div className="flex items-center space-x-2">
                <Lock className="w-4 h-4 text-blue-600" />
                <span className="calm-text font-medium">End-to-end encryption</span>
              </div>
              <div className="flex items-center space-x-2">
                <Shield className="w-4 h-4 text-emerald-600" />
                <span className="calm-text font-medium">Secure data storage</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-50 to-slate-50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-5xl font-bold text-slate-800 mb-8">
            Ready to meet your <span className="apple-text-gradient">future self</span>?
          </h2>
          <p className="text-xl calm-text mb-12 max-w-2xl mx-auto font-light">
            Start your journey today and unlock the wisdom of your future self in a secure, 
            trusted environment.
          </p>
          <Link href="/setup">
            <button className="apple-button text-lg px-10 py-4 relative z-10">
      ...
      {/* Footer */}
      <footer className="border-t trust-border py-12 px-6 bg-white/80">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              <Brain className="w-6 h-6 security-accent" />
              <span className="text-lg font-bold security-accent">SoulSync</span>
            </div>
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                <Shield className="w-4 h-4 text-emerald-600" />
                <span className="text-sm text-emerald-600 font-medium">Privacy First</span>
              </div>
              <div className="calm-text">
                <p>© 2024 SoulSync. Connect with your future self securely.</p>
              </div>
            </div>
          </div>
        </div>
